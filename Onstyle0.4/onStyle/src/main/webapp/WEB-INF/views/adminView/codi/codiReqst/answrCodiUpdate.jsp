			...
			<div id="canvas" style="float:left; width:37%; height:91%;">
			 	...
			 	<c:if test="${ReadPageNme eq 'answr'}">
					<div class="col-lg-12" id="mentBox" style = "margin-top:87%; width:100%; z-index:5">
						<textarea class="form-control" rows="3" id="ment" name="answr_contnt" placeholder="요청 사항을 입력해주세요!" 
						style="border:1px solid #e5e5e5; background-color:white; text-align: center;" >${reqstVO.answr_contnt}</textarea>
					</div>
				</c:if>
			</div>
