...
<!-- 상단 바 -->
	...
	<input type="hidden" name="codi_seq" value="${reqstVO.codi_seq}">
	...
	<input type="hidden" name="admin" value="1">
		...
		<div id="collage_container" style="height: 80%;">
			...
			<div id="canvas_menu" style = "width:37%">
				<a href="#" onclick="saveCodi(4)" class="btn btn-info" style=" margin-top: 17px;">답변하기</a> 
			...
			<div id="canvas" style="float:left; width:37%; height:91%;">
			 	...
			 	<!-- 멘트 입력란 -->
				<div class="col-lg-12" id="mentBox" style = "margin-top:87%; width:100%; z-index:5">
					<textarea class="form-control" rows="3" id="ment" name="answr_contnt" placeholder="답변을 작성 해주세요!" 
					style="border:1px solid #e5e5e5; background-color:white; text-align: center;" ></textarea>
				</div>
			</div>
