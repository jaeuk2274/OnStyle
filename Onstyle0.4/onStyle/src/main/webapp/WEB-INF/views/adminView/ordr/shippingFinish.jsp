			...
			<thead></thead>
				<tr>
					<th colspan="8" style="border-bottom: 1px solid #C6C6C6; width:25%; height:30px;">
						<a href="#" class="btn btnjin btn-xs" style="margin-left:10px; float:left;"> 배송완료 처리 </a> 
						<a href="#" class="btn btnjin btn-xs" style="margin-left:10px; float:left;"> 배송준비중 처리 </a>
				...
				<c:forEach var ="ordrVO" items="${shippingFinList}">
