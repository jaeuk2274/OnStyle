...
<body style="height:100%">
	...
	<form id="codiInsertForm" name="codiInsertForm">
		...
		<div id="collage_container" style="height: 80%;">
			...
			<div id="canvas_menu">
				<a href="#" onclick="saveCodi(0)" class="btn btn-info" style=" margin-top: 17px;">코디요청</a> 
			...
			<div id="canvas" style="float:left; width:42%; height:91%;">
				...
				<!-- 멘트 입력란 -->
				<div class="col-lg-12"  id="mentBox" style = "margin-top:75%; width:100%; z-index:5">
					<textarea class="form-control" rows="3" id="ment" name="codi_reqst_contnt" placeholder="요청 사항을 입력해주세요!" 
					style="background-color:white; border:1px solid #e5e5e5; text-align: center;" ></textarea>
				</div>
			</div>
