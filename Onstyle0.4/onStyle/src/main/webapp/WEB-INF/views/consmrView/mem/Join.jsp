...
function upFinish(){
	...
	$.ajax({
	   ...
	   success:function(data){
	      alert("수정이완료되었습니다.");
	      $("#pw").val('');
//             $("#birth").val(data.mem_birth);
//             $("#postcd").val(data.mem_postcd);
//             $("#adrs").val(data.mem_adrs);
//             $("#detail_adrs").val(data.detail_adrs);
//             $("#ph").val(data.mem_ph);
//             $("#email").val(data.mem_email);
	   },
	   error:function(xhr,status,error){ //ajax 오류인경우  
	      alert("error\nxhr : " + xhr + ", status : " + status + ", error : " + error);       
	   }
	});
//       document.jo.action ="/upFinish.do";
//       document.jo.submit();
//       window.location.href="/upFinish.do";
}
...
<body>
	...
	<div class="mainContainer">
		...
		<font style="font-weight:bold; font-size:x-large; "> JOIN </font>
	</div>
	<br>
	<div>
	...
	<div align="center">
         	<form name="jo" id="jo" method="post">
	            <table  class="table table-bordered"  border="1">
	               <tr>
	                  <th rowspan="3" style="width:170px">
	                  프로필
	               ...
	               <tr>
	                  <td>
	                    <div style="float:left;">닉네임</div>
	                     ...
	                     <font style="text-align:left; padding-left:10px;">${memship.mem_nicknme} </font>
	               ...
	               <tr>
	                  ...
	                  <td>
	                     <input type="text" style="border: 1px solid #BDBDBD; width:250px;height:30px;" value="${memship.mem_ph}" id="mem_ph3" name="mem_ph3" maxlength="11" onKeydown="this.value=this.value.replace(/[^0-9]/g,'');">
	                  </td>
	               </tr>
	               <tr>
	                  <th>
	               ...
	               <table class="hide table table-bordered" id="size" style="margin-top:-23px;">
	               <tr>
	               		<th style="width:170px;">
	               			상의 총기장(cm)
	               		</th>
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_top_length" name="mem_top_length" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_top_shouldr" name="mem_top_shouldr" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	               <tr">
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_top_bust" name="mem_top_bust" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_top_tail_girth" name="mem_top_tail_girth" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_top_slv_length" name="mem_top_slv_length" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_top_slv_opening" name="mem_top_slv_opening" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_top_slv_bill" name="mem_top_slv_bill" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');" >
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_bottom_length" name="mem_bottom_length" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_bottom_waist" name="mem_bottom_waist" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');" >
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_bottom_hip" name="mem_bottom_hip" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               ...
	               <tr>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_bottom_front_width" name="mem_bottom_front_width" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	               <tr>
	               		<th>
	               		...
	               		<td>
	               			<input type="text" style="border: 1px solid #BDBDBD; width:80px;height:30px;" id="mem_bottom_back_width" name="mem_bottom_back_width" maxlength="5" onKeydown="this.value=this.value.replace(/[^0-9,.]/g,'');">
	               		</td>
	               </tr>
	            </table>
	     	</form>
