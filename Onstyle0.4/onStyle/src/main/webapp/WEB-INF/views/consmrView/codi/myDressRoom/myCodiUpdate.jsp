...
<body>
	...
	<form id="codiInsertForm" name="codiInsertForm">
		...
		<input type="hidden" name="codi_seq" value="${codi_seq}">
		...
		<div id="collage_container" style="height: 80%;">
			...
			<div id="canvas" style="float:left; width:42%; height:91%;">
			 	...
			 	<!-- 멘트 입력란 -->
			 	<c:if test="${ReadPageNme eq 'reqst'}">
					<div class="col-lg-12" id="mentBox" style = "margin-top:75%; width:99%; z-index:5">
						<textarea class="form-control" rows="3" id="ment" name="codi_reqst_contnt" placeholder="요청 사항을 입력해주세요!" 
						style="border:1px solid #e5e5e5; background-color:white; text-align: center;" >${reqstVO.codi_reqst_contnt}</textarea>
					</div>
				</c:if>
			</div>
