...
<link href="/resources/consmr/main/consmrBootstrap/css/bootstrap.css"
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbar-main">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#" id="download">Paper <span
							class="caret"></span></a>
						<ul class="dropdown-menu" aria-labelledby="download">
							<li><a href="http://jsfiddle.net/bootswatch/ndax7sh7/">Open
									Sandbox</a></li>
							<li class="divider"></li>
				...
				<div class="col-lg-4 col-md-5 col-sm-6">
					<div class="sponsor">
						<script async type="text/javascript"
							src="//cdn.carbonads.com/carbon.js?zoneid=1673&serve=C6AILKT&placement=bootswatchcom"
				...
				<div class="col-lg-3 col-md-3 col-sm-4">
					<div class="list-group table-of-contents">
						<a class="list-group-item" href="#navbar">Navbar</a> <a
							class="list-group-item" href="#buttons">Buttons</a> <a
				...
				<div class="col-lg-12">
					...
					<p>
						Made by <a href="http://thomaspark.co" rel="nofollow">Thomas
							...
							href="/cdn-cgi/l/email-protection#3b4f5354565a487b5954544f484c5a4f585315585456"><span
							class="__cf_email__"
							data-cfemail="b6c2ded9dbd7c5f6d4d9d9c2c5c1d7c2d5de98d5d9db">[email&#160;protected]</span>
