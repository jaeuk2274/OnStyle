...
<body>
	<table class="table table-hover" style="margin-top:7%">
		<thead>
			<tr class="active">
		...
		<tbody>
			<c:forEach var="reqstList" items="${reqstList}" varStatus="status">
				<tr>
					...
					<td onclick="reqstRead(${reqstList.codi_reqst_seq})" class="text-center" style="vertical-align: middle; width:5%; cursor:pointer">${reqstList.codi_reqst_seq}</td>
					<td onclick="reqstRead(${reqstList.codi_reqst_seq})" class="text-center" style="vertical-align: middle; width:5%; cursor:pointer"><img src="${reqstList.reqst_codi_img_route}" class="thumbnail"></td>
					<td onclick="reqstRead(${reqstList.codi_reqst_seq})" class="text-center" style="vertical-align: middle; width:5%; cursor:pointer"><img src="${reqstList.answr_codi_img_route}" class="thumbnail"></td>
					<td onclick="reqstRead(${reqstList.codi_reqst_seq})" class="text-center" style="vertical-align: middle; width:50%; cursor:pointer">${reqstList.codi_reqst_contnt}</td>
					<td onclick="reqstRead(${reqstList.codi_reqst_seq})" class="text-center" style="vertical-align: middle; width:10%; cursor:pointer">${reqstList.codi_reqst_date}</td>
					<c:if test="${reqstList.codi_reqst_state eq 'n'}">
						<td onclick="reqstRead(${reqstList.codi_reqst_seq})" class="text-center" style="vertical-align: middle; width:10%; color:limegreen; cursor:pointer">요청</td>
					</c:if>
					<c:if test="${reqstList.codi_reqst_state eq 'y'}">
						<td onclick="reqstRead(${reqstList.codi_reqst_seq})" class="text-center" style="vertical-align: middle; width:10%; color:red; cursor:pointer">완료</td>
					</c:if>
				</tr>
			</c:forEach>
		</tbody>
