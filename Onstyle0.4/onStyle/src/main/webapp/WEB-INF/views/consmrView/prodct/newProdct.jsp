...
<script>			
	...
	function prodctSelect(prodct_state){
		window.location.href = "/prodctFrameSelect.do?prodct_state="+prodct_state;
	}
//		thumbnail
	    	...
	    	$.ajax({ 		 		
				...
				success:function(data){
					if(data.codi_img_route != null){
						$("body").append("<p id='preview'><img src='"+data.codi_img_route+"' width='300px' height='300px' /></p>"); //보여줄 이미지를 선언                       
			 	        $("#preview")
