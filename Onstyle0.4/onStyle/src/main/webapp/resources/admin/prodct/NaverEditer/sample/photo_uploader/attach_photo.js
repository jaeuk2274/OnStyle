	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : "/resources/admin/prodct/NaverEditer/sample/photo_uploader/file_uploader.jsp",	//(샘플 URL입니다.)  샘플URL변경했습니다[남진우]
 	        sCallback : '/resources/admin/prodct/NaverEditer/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
